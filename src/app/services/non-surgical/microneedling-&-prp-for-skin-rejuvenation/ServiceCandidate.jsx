      ...
      <div className="flex w-full max-w-[1200px]">
        ...
        <div className="flex flex-col w-full">
          ...
          <h2 className="text-4xl font-bold max-lg:text-3xl font-notoSans text-[#10217D] leading-tight mb-4">
            Why Choose Microneedling & PRP for Skin Rejuvenation with Kunal Sayani :
          </h2>
          ...
          <ul className="space-y-3 text-gray-800">
            {[
              `Expertise in combining microneedling with PRP therapy for enhanced skin regeneration
`,
              `Use of advanced, medical-grade devices to ensure precision and safety during treatment
`,
              `Personalized treatment plans tailored to address acne scars, fine lines, pores, and dull skin`,
              `
Use of your own platelet-rich plasma (PRP) to naturally boost collagen and healing response
`,
              `Minimally invasive with quick recovery time and long-lasting skin rejuvenation effects
`,
              `
Clean, sterile environment with strict adherence to hygiene and safety protocols

`,
              `Proven results with improved skin texture, tone, and youthful glow over multiple sessions
`,
            ].map((item, index) => (

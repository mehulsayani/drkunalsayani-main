          ...
          >
            ...
            >
              ...
              <div className={`${readMore ? "blur-[3px]" : "blur-[0px]"}`}>
                ...
                <h3 className="font-semibold mt-4">Specific Risks for Surgical Chin Augmentation:</h3>
                <ul className="list-disc ml-6 space-y-2 mb-3">
                  {data.risks.surgicalRisks.map((risk, index) => (
                    <li key={index}>{risk}</li>
                  ))}
                </ul>
                <h3 className="font-semibold mt-4">Specific Risks for Non-Surgical Chin Augmentation:</h3>
                <ul className="list-disc ml-6 space-y-2 mb-3">

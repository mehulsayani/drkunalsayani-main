  ...
  return (
    <section className="pt-[8rem] max-lg:pt-[4rem]">
       {/* ✅ OG & Twitter Meta Tags */}
        <meta property="og:title" content="About Tvameva Clinic | Cosmetic and Aesthetic Surgery Clinic in Mumbai" />
        <meta
          property="og:description"
          content="Discover Tvameva Clinic in Andheri, Mumbai, your one stop destination for advanced cosmetic and plastic surgery care treatments with expert care and modern technology."
        />
      <AboutTvameva />

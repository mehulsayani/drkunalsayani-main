...
export default function page() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-6 text-center pt-[8rem]">
      ...
      <h1 className="text-4xl md:text-5xl font-bold text-[#1AAEBC] mb-4">Oops! Page Not Found</h1>
      <p className="text-gray-600 text-lg max-w-md mb-6">
        The page you're looking for doesn’t exist or has been moved.
      </p>
      <Link href="/">
        <p className="bg-[#1AAEBC] text-white px-6 py-3 rounded-full shadow-md hover:bg-sky-700 transition">
          Go Back Home
        </p>
      </Link>
    </div>

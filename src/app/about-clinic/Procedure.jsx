...
import Image from "next/image"; // Only needed if using Next.js
...
const Procedures = () => {
  ...
  return (
    <div className="bg-[#F5F0E8] px-6 max-w-[1200px] w-full md:px-20 py-16 flex flex-col md:flex-row gap-10">
      {/* Left: Text + Accordion */}
      ...
      <div className="md:w-1/2 relative">
        <Image
          src="/images/facial-treatment.jpg" // Replace with actual path
